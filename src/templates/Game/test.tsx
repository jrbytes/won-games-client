...
import Game, { GameTemplatePros } from '.'
...
describe('<Game />', () => {
  it('should be able to render the template with components', () => {
  ...
  it('should not be able to render the gallery if no images', () => {
    renderWithTheme(<Game {...props} gallery={undefined} />)

    expect(screen.queryByTestId('Mock Gallery')).not.toBeInTheDocument()
  })

  it('should not be able to render the gallery on mobile', () => {
    renderWithTheme(<Game {...props} />)
  ...
  it('should be able to render the cover image', () => {
    renderWithTheme(<Game {...props} />)
